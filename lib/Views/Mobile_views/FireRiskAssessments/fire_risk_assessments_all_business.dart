...
class FireRiskAllBusiness extends StatefulWidget {
  const FireRiskAllBusiness({super.key});

  @override
  State<FireRiskAllBusiness> createState() => _FireRiskAllBusinessState();
}

class _FireRiskAllBusinessState extends State<FireRiskAllBusiness> {
