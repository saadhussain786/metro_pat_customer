...
class CommercialEICRTesting extends StatefulWidget {
  const CommercialEICRTesting({super.key});

  @override
  State<CommercialEICRTesting> createState() => _CommercialEICRTestingState();
}

class _CommercialEICRTestingState extends State<CommercialEICRTesting> {
